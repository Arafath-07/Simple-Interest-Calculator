...
// state creating for error message
...
{/* invlalid principle */}
{
 ...
 {/* interest rate */}
 <div className='mb-3'>
<TextField value={rate ||""} name='rate'  onChange={e=>validateInputs(e.target)} className='w-100' id="outlined-interest" label="Rate of Interest (%)" variant="outlined" />
</div>
{/* invlalid rate */}
{
